export function optionalFlag(args, name) {
...
export function logPageOptions(args) {
...
export function selectEventPage(events, options) {
    ...
    for (const event of events) {
        ...
        if (event.sequence <= options.after)
            continue;
