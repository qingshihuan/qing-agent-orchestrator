import type { ModelRole, RiskLevel, TaskCategory, TaskComplexityAnalysis } from "./types.js";
...
export function analyzeTaskComplexity(input: TaskAnalyzerInput): TaskComplexityAnalysis {
  const text = input.text.trim();
  if (!text) throw new Error("Task analyzer requires non-empty text.");
